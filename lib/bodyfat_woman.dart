...
class BodyFatWoman extends StatefulWidget {
  Color background;
  Color text;
  bool english;

  BodyFatWoman({this.background, this.text, this.english});

  @override
  _BodyFatWomanState createState() => _BodyFatWomanState();
}

class _BodyFatWomanState extends State<BodyFatWoman>
  ...
  TextEditingController _hipController = new TextEditingController();
                    ...
                    if (height <= 0 || neck <= 0 || waist <= 0 || hip <= 0) {
                      Navigator.pushReplacement(
                        ...
                        PageRouteBuilder(
                          ...
                          pageBuilder: (_, __, ___) => BodyFatWoman(),
                        ),
                      );
                    }
                    result = (163.205 * log10(waist + hip - neck) -
                            97.684 * (log10(height)) -
                            78.387)
                        .toString();
                  });
