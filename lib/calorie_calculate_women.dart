...
class CaloriePageWomen extends StatefulWidget {
  Color background;
  Color text;
  bool english;

  CaloriePageWomen({this.background, this.text, this.english});

  @override
  _CaloriePageWomenState createState() => _CaloriePageWomenState();
}
...
class _CaloriePageWomenState extends State<CaloriePageWomen> {
  double weight;
  int height;
                        ...
                        if (height > 250 ||
                          ...
                          Navigator.pushReplacement(
                            ...
                            PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => CaloriePageWomen(
